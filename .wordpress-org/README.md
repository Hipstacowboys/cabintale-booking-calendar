...
| File | Size | Must show |
|---|---|---|
| `screenshot-1.png` | 1280px wide or wider | The widget on a published page, real dates and prices |
...
| `screenshot-4.png` | same | Settings → Cabintale, with a preview open |
...
- **Screenshot numbers are positional.** `screenshot-3.png` is described by the third line under `== Screenshots ==` in [`readme.txt`](../readme.txt). Reordering the images without reordering the captions mislabels them on the listing.
